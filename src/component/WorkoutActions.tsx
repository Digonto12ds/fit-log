  ...
  return (
    <div className="mt-10 flex flex-col gap-3 sm:flex-row">
      ...
      <button
        ...
        className="flex flex-1 items-center justify-center gap-2 rounded-full border border-zinc-600 px-6 py-3 font-black text-white transition hover:border-[#ccff00] hover:text-[#ccff00]"
      >
        Save for later
      </button>
    </div>
